...
.data 
  ...
  p_int:        .asciiz "\n Hay nhap vao so thu nhat co do dai  4 chu so, VD: nhan 0021 de nhap so 21.\n"
  p_int1:       .asciiz "\n Hay nhap vao so thu hai co do dai  4 chu so, VD: nhan 0021 de nhap so 21.\n"
